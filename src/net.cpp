...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "WPCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seed1.whitepalacecoin.com", "seed1.whitepalacecoin.com"},
    {"seed2.whitepalacecoin.com", "seed2.whitepalacecoin.com"},
    {"seed3.whitepalacecoin.com", "seed3.whitepalacecoin.com"},
    {"seed4.whitepalacecoin.com", "seed4.whitepalacecoin.com"},
	{"seed5.whitepalacecoin.com", "seed5.whitepalacecoin.com"},
    {"seed6.whitepalacecoin.com", "seed6.whitepalacecoin.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. WPCoin is probably already running."), addrBind.ToString().c_str());
        else
